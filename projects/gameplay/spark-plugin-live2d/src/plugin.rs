...
use crate::backend::NullLive2dBackend;
use crate::runtime::{Live2dModelId, Live2dRuntime};
...
impl Plugin for Live2dPlugin {
    fn info(&self) -> PluginInfo {
        PluginInfo {
            id: "live2d",
            version: "0.1.0",
            description: "Live2D 模型参数与动作（脚本插件）",
        }
    }
...
mod tests {
    ...
    fn install_and_load_via_vm() {
        ...
        reg.register(Box::new(Live2dPlugin::with_null_backend()))
            .unwrap();
